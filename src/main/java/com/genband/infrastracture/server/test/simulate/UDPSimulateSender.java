...
public class UDPSimulateSender {
  ...
  public static void main(String args[]) throws UnknownHostException, InterruptedException {
    ...
    // "Max-Forwards: 70",
    // "Contact: <sip:testagent01@172.28.19.60:5090;rinstance=94b99f6f8d82633e>",
    // "To: <sip:testagent01@spidr.dev.genband.com>",
    // "From: <sip:testagent01@spidr.dev.genband.com>;tag=6b7e7072",
    ...
    // System.out.println();
    // String address = "172.28.248.8:9102";
    // String newStr = str.replaceAll("Contact: <sip:([a-zA-Z0-9\\.\\:]+)@([a-zA-Z0-9\\.\\:]+)",
    // "Contact: <sip:$1@" + address);
    //
